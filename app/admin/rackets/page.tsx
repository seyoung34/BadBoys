...
import type { RacketRow, RacketVariant } from "@/app/lib/types";
                ...
                <table className="w-full text-left text-sm">
                    <thead className="bg-slate-200 border-b border-slate-200">
                        <tr>
                            ...
                            <th className="px-4 py-2 font-semibold">무게분류</th>
                            <th className="px-4 py-2 font-semibold">밸런스</th>
